...
public class MachineDao {
    ...
    public List<MachineViewDtoTwo> myMachineInfo(int userId) {
        Connection conn = null;
        Statement stmt = null;
        ResultSet rs = null;
        List<MachineViewDtoTwo> machineList = new ArrayList<>();
        try {
            conn = connectionMaker.createConnection();
...
//            String state;
            ...
            if(using_machine_id != 0){
                ...
                while (rs.next()) {
                    ...
                    MachineViewDtoTwo machineViewDto = new MachineViewDtoTwo(1, machine_id, name, type, targetMuscle, state);
            ...
            if(reserve_machine_id != 0){
                ...
                while (rs.next()) {
                    ...
                    String targetMuscle = rs.getString(4);
                    String state = rs.getString(5);
                    MachineViewDtoTwo machineViewDto = new MachineViewDtoTwo(2, machine_id, name, type, targetMuscle, state);
                    machineList.add(machineViewDto);
                }
            }
